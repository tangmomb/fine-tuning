...
sys.path.insert(0, str(ROOT / "evaluation_brut_models"))
...
OUTPUT_ROOT = ROOT / "evaluation_brut_models" / "runs_openai"
...
def submit(args: argparse.Namespace, model: str, mode: str, few_shot_k: int, limit: int | None) -> None:
    ...
    print(f'  python evaluation_brut_models\\run_openai.py --action retrieve --run-dir "{run_dir}"')
