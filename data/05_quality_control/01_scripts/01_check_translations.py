...
def manual_corrections(environment: str) -> dict[str, str]:
    ...
    path = PROJECT_DIR / "data" / "05_quality_control" / folder / "02_manual_corrections" / "manual_corrections.jsonl"
    if not path.is_file():
        return {}
    corrections = {}
...
def main() -> None:
    ...
    folder = {"pilot": "02_pilot", "production": "03_production"}[environment]
    source_dir = PROJECT_DIR / "data" / "04_merge_translations" / folder
    output_dir = PROJECT_DIR / "data" / "05_quality_control" / folder / "01_deterministic_checks"
