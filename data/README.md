...
```text
00_documentation/01_pipeline_visualisation/    documentation HTML du pipeline
...
```powershell
python data/01_prepare/01_scripts/01_check_original_dataset.py
python data/01_prepare/01_scripts/02_prepare_english_dataset.py
python data/02_translation_batches/01_scripts/01_create_and_send_batches.py
python data/03_batch_responses/01_scripts/01_download_batch_responses.py
python data/04_merge_translations/01_scripts/01_merge_translations.py
python data/05_quality_control/01_scripts/01_check_translations.py
