...
02_batch/              requêtes Batch prêtes à transmettre à OpenAI
03_open_ai_response/   réponses JSONL brutes téléchargées depuis OpenAI
...
Le troisième script prépare localement le pilote Terra (deux lots de 50 requêtes), puis demande explicitement avant de l'envoyer. Après l'envoi, le même script affiche le statut des derniers Batch et propose de récupérer les traductions lorsqu'ils sont terminés.
