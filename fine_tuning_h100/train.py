...
réservé à evaluation_brut_models afin d'éviter toute fuite de données.
"""
...
DATASET = ROOT / "data" / "06_training_dataset" / "03_production" / "train.jsonl"
VALIDATION_DATASET = ROOT / "data" / "06_training_dataset" / "03_production" / "validation.jsonl"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-root", type=Path, default=ROOT / "fine_tuning_h100" / "artifacts" / "adapters")
