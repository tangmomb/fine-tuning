...
DATASETS = (
    ("Apprentissage", "train", ROOT / "01_data" / "06_training_dataset" / "03_production" / "train.jsonl", "training"),
    ("Apprentissage", "validation", ROOT / "01_data" / "06_training_dataset" / "03_production" / "validation.jsonl", "training"),
    ("Évaluation", "test_inputs", ROOT / "01_data" / "07_evaluation_dataset" / "03_production" / "test_inputs.jsonl", "evaluation_input"),
    ("Évaluation", "test_gold", ROOT / "01_data" / "07_evaluation_dataset" / "03_production" / "test_gold.jsonl", "evaluation_gold"),
)
