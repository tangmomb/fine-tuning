...
SOURCE = ROOT / "01_data" / "04_merge_translations" / "03_production" / "test.jsonl"
OUTPUT_DIR = ROOT / "01_data" / "07_evaluation_dataset" / "03_production"
...
def correction_map() -> dict[str, str]:
    path = ROOT / "01_data" / "05_quality_control" / "03_production" / "02_manual_corrections" / "manual_corrections.jsonl"
    if not path.is_file():
        return {}
    return {
        row["id"]: row["question"]
...
def main() -> None:
    ...
    checks_path = ROOT / "01_data" / "05_quality_control" / "03_production" / "01_deterministic_checks" / "test_deterministic_checks.jsonl"
    judgments_path = ROOT / "01_data" / "05_quality_control" / "03_production" / "09_judgments" / "sol_judgments_test.jsonl"
