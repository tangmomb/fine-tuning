...
def selection_records():
    ...
    for split in splits:
        translations = rows(ROOT / "01_data" / "04_merge_translations" / "03_production" / f"{split}.jsonl")
...
def main():
    ...
    SOURCE = ROOT / "01_data" / "04_merge_translations" / folder / "train_spider.jsonl"
    WORK = ROOT / "01_data" / "05_quality_control" / folder
